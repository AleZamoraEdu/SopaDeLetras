...
/**
 * Clase principal de la Interfaz Gráfica de Usuario (IGU). Representa la
 * ventana principal de la aplicación, gestionando la interacción del usuario y
 * la presentación de los datos.
 *
 * @author Alejandro Zamora, Roger Balan, Asistente IA
 */
