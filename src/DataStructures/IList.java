...
public interface IList<T> {
    ...
    /**
     * Adds an element at the specified index in the list. Shifts the element
    ...
    /**
     * Returns the head node of the list. This is generally not part of a public
     * list interface but can be useful for testing or specific advanced
     * operations.
     *
    ...
    /**
     * Returns the tail node of the list. This is generally not part of a public
     * list interface but can be useful for testing or specific advanced
     * operations.
     *
